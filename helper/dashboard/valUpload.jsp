...
if((contentType != null)&&(contentType.indexOf("multipart/form-data") >= 0)){
    ...
    FileOutputStream fileOut = new FileOutputStream("C:/Program Files/Apache Software Foundation/Tomcat 7.0/webapps/rems/admin/dashboard/upload/"+ff);
    ...
    try{
        ...
        int i=stmt.executeUpdate("update help set fstatus='1', fname='"+saveFile+"' where email='"+cookieLogin.getValue()+"'");
