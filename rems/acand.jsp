...
<center><h2>Status Not Verified Candidates</h2></center>

<div align="center" width="85%">
<center>
    <form name="candverif" method="post" action="valcandverif.jsp">
...
<td bgColor="#008080" width="270" height="19"><font color="#ffffff"><b>Exam Center</b></font></td>
<td bgColor="#008080" width="107" height="19"><font color="#ffffff"><b>Verification Credentials</b></font></td>
<td bgColor="#008080" width="107" height="19"><font color="#ffffff"><b>Candidate Status</b></font></td>
...
String url="jdbc:mysql://localhost/exam?user=root&password=root";

int i=1;
con=DriverManager.getConnection(url);
stmt=con.createStatement();
rst=stmt.executeQuery("select * from cand where status=0");
...
<td bgColor="#ffff98" vAlign="top" width="270" height="19"><%=rst.getString(7)%></td>
...
{
    %><td bgColor="#ffff98" vAlign="top" width="270" height="19"><a href="upload/<%=rst.getString(10)%>" target="_top">View</a></td>
      <td bgColor="#ffff98" vAlign="top" width="270" height="19"><input type="checkbox" name="verifcand" value="<%=rst.getString(1)%>">Verified</td>
    <% } %>
</tr>
<%
}else{
...
{
    %><td bgColor="#ffff98" vAlign="top" width="270" height="19"><a href="upload/<%=rst.getString(10)%>" target="blank">View</a></td>
      <td bgColor="#ffff98" vAlign="top" width="270" height="19"><input type="checkbox" name="verifcand" value="<%=rst.getString(1)%>">Verified</td>
      <% } %>
</tr>
<% }
...
<br>
<center><h2>Status Verified Candidates</h2></center>
...
<td bgColor="#008080" width="270" height="19"><font color="#ffffff"><b>eMail</b></font></td>
<td bgColor="#008080" width="270" height="19"><font color="#ffffff"><b>Exam Center</b></font></td>
<td bgColor="#008080" width="270 height="19"><font color="#ffffff"><b>Reg. Number Generated</b></font></td>
...
try{
String url2="jdbc:mysql://localhost/exam?user=root&password=root";

int j=1;
con2=DriverManager.getConnection(url2);
stmt2=con2.createStatement();
rst2=stmt2.executeQuery("select * from cand where status=1");
while(rst2.next()){
...
<td bgColor="#ffff98" vAlign="top" width="270" height="19"><%=rst2.getString(7)%></td>
<td bgColor="#ffff98" vAlign="top" width="270" height="19"><%=rst2.getString(9)%></td>
</tr>
<%
}else{
%>
